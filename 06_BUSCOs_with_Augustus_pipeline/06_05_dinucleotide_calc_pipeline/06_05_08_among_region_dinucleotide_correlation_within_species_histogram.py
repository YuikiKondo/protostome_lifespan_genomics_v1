...
file_path = '/home/y-kondo/protostome_lifespan_model_augustus/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/dinucleotide_count/among_region_dinucleotide_correlation_results_Github_check.csv'
correlation_data = pd.read_csv(file_path)

# Define regions and colors
regions = ["upstream1", "upstream2", "exon", "intron", "downstream1", "downstream2"]
region_colors = {
