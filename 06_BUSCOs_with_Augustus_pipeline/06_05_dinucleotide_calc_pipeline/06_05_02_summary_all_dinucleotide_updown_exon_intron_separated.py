...
def calculate_dinucleotide_metrics(file_path):
    ...
    try:
        ...
        for region, metrics in cumulative_metrics.items():
            ...
            # Calculate total mononucleotide count (A + T + G + C)
            ...
            dinucleotide_rates = {
                di: metrics[di] / total_length if total_length > 0 else 0
                for di in dinucleotides
            }
...
if __name__ == "__main__":
    input_dir = "/home/y-kondo/protostome_lifespan_model_augustus/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/dinucleotide_count/busco_gene_summaries_Github_check"
    output_file = "/home/y-kondo/protostome_lifespan_model_augustus/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/dinucleotide_count/summary_dinucleotide_rates_region_separated_Github_check.csv"
