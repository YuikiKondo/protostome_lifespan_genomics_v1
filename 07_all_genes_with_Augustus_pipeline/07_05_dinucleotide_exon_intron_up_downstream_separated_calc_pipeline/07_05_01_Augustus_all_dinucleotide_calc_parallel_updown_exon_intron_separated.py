...
def process_all_fasta_files(input_dir, output_dir, num_processes):
    ...
    for fasta_file in os.listdir(input_dir):
        if fasta_file.endswith(".fasta"):
            species = fasta_file.replace("_augustus_all_genes.fasta", "")
...
if __name__ == "__main__":
    input_dir = "/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/augustus_sequences/"
    output_dir = "/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/dinucleotide_count/augustus_gene_summaries_Github_check/"
