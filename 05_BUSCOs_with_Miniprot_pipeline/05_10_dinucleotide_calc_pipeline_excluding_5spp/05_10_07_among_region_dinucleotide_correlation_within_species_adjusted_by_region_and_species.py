...
# Load the dataset
#! Run 05_10_12_add_intergenic_rows_to_7region_file.py prior to this code
file_path = "/home/y-kondo/protostome_lifespan_model/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/dinucleotide_count_excluding_5spp/dinucleotide_PGLS/filtered_species_with_tip_name_dinuc_Github_check_plus_intergenic.csv"
...
regions = ["genome", "intergenic", "upstream1", "upstream2", "exon", "intron", "downstream1", "downstream2"]
dinucleotide_rates = [
...
# Save to CSV
output_path = "/home/y-kondo/protostome_lifespan_model/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/dinucleotide_count_excluding_5spp/among_region_dinucleotide_correlation_results_Github_check.csv"
